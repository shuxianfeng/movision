...
public class ExpertController {
    ...
    public JsonResult publishAchievement(Achievement achievement) throws IOException {
    ...
    public JsonResult queryAchievementById(@RequestParam String id) throws IOException {
        JsonResult jsonResult = new JsonResult();
    ...
    public JsonResult deleteAchievement(@RequestParam String ids[]) throws IOException {
        JsonResult jsonResult = new JsonResult();
    ...
    public JsonResult updateAchievement(Achievement achievement) throws IOException {
        JsonResult jsonResult = new JsonResult();
        expertService.updateAchievement(achievement);
        return jsonResult;
    }
