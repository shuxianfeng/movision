...
public class ZhbPayController {
    ...
    public Response doZHBOrder(@ApiParam @ModelAttribute ZHBOrderReqBean order) {
        ...
        paramMap.put("partner", PARTNER);// partner=seller_id 商家支付宝ID 合作伙伴身份ID
                                         // 签约账号
        // 生成订单编号
    ...
    public void doPay(HttpServletRequest request, HttpServletResponse response, @ApiParam @ModelAttribute PayReqBean pay) throws Exception {
        ...
        paramMap.put("alipay_goods_type", PayConstants.GoodsType.XNL.toString());// 商品类型
                                                                                 // 0
                                                                                 // ,
                                                                                 // 1
        paramMap.put("partner", PARTNER);// partner=seller_id 商家支付宝ID 合作伙伴身份ID
