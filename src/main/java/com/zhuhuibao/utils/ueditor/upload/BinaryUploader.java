...
public class BinaryUploader {
    ...
    public static final State saveToObject(HttpServletRequest request,
                                           Map<String, Object> conf) {
        String uploadMode = PropertiesUtils.getValue("upload.mode");
        if ("zhb".equals(uploadMode)) {
            return save(request, conf);
        } else if ("alioss".equals(uploadMode)) {
            return saveToAliOSS(request, conf);
        } else{
            return new BaseState(false);
        }
    }

    public static final State saveToAliOSS(HttpServletRequest request,
                                           Map<String, Object> conf) {
...
//            String physicalPath = conf.get("uploadRootPath") + savePath;
            ...
            Map<String, String> result = aliOSSClient.uploadStream(is, originFileName, maxSize,
