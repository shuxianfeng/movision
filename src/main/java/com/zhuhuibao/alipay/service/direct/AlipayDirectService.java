...
public class AlipayDirectService {
    ...
    public void h5Pay(HttpServletResponse httpResponse, OrderFlow orderFlow, Map<String, String> msgParam) throws ServletException, IOException, AlipayApiException {
        ...
        alipayRequest.setBizContent("{" + "    \"out_trade_no\":" + orderFlow.getOrderNo() + "," + "" + "    \"total_amount\":" + orderFlow.getTradeFee() + "," + "    \"subject\":"
                + msgParam.get("goodsName") + "," + "    \"seller_id\":," + AlipayPropertiesLoader.getPropertyValue("seller_id") + "    \"product_code\":" + orderFlow.getOrderNo() + "  }");// 填充业务参数
