    ...
    public Map releaseModularPost(HttpServletRequest request, String userid, String circleid, String title, String subtitle,
        ...
        if (scope == 2
            ...
            try {
                ...
                insertPostShareGoods(proids, flag);
                //3 标签业务逻辑处理
                if (StringUtil.isNotBlank(labellist)) {
...
/*
     ...
     * @return
     */
    public List activePostDetailHot_20171220(int type, String postid, Paging<PostVo> paging, String device) throws NoSuchAlgorithmException, InvalidKeyException, IOException {
        List<PostVo> list = null;
        if (type == 0) {//最热
