...
//        (String username,String headImg)
    ...
    public Map He(InputStream is, String manname, String womanname, String msex, String wsex) {
        ...
        try {
            ...
            g.rotate(30, 900, -15);
            g.drawImage(img, 700, 900, this);
            //g.rotate(30);
            //设置颜色。
            g.setColor(Color.BLACK);

            //最后一个参数用来设置字体的大小
            Font f = new Font("宋体", Font.PLAIN, 86);
            Color color = new Color(146, 140, 149);
            ...
            for (int i = 0; i < 1; i++) {
                ...
                g.drawString(manname, -160, 2200);
                g.drawString(womanname, -180, 2950);
                g.drawString(msex, 1300, 2250);
                g.drawString(wsex, 1300, 2950);
