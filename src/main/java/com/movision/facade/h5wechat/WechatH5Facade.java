    ...
    public Map LiHun(InputStream is, String manname, String womanname, String content) {
        ...
        try {
            ...
            for (int i = 0; i < 1; i++) {
                ...
                g.setPaint(mycolor[i % 2]);
                g.drawString(manname, 208, 167);
                g.drawString(womanname, 210, 208);
                g.drawString(manname, 262, 808);
                g.drawString(womanname, 620, 812);
                g.drawString(content, 274, 265);
                g.drawString(year, 130, 847);
                g.drawString(month, 185, 847);
                g.drawString(day, 215, 847);
                g.drawString(year, 470, 850);
