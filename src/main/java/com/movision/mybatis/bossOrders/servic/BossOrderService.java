...
public class BossOrderService {
     ...
     * 增加物流关系表
     *
     * @param logidticsRelation
     * @return
     */
    public Integer addLogisticsRalation(LogidticsRelation logidticsRelation) {
        try {
            loger.info("增加物流关系表");
            return bossOrdersMapper.addLogisticsRalation(logidticsRelation);
        } catch (Exception e) {
            loger.error("增加物流关系表失败", e);
            throw e;
        }
    }
    /**
