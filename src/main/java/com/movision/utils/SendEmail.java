...
public class SendEmail {
    ...
    public static final String FROM = "movision@zhuangyuhao.com";//发件人的email
    ...
    public static void main(String[] args) {
    	/*String serverIp = "120.77.214.187";
