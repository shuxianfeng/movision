...
public class VerifyCodeUtils {
    ...
    public static final String VERIFY_CODES_DIGIT = "0123456789";
     ...
     * @throws IOException 
     */  
    public static void outputImage1(int w, int h, ServletOutputStream os, String code) throws IOException{  
        int verifySize = code.length();  
        BufferedImage image = new BufferedImage(w, h, BufferedImage.TYPE_INT_RGB);  
        Random rand = new Random();  
        Graphics2D g2 = image.createGraphics();  
    ...
    public static void main(String[] args) throws IOException{  
        File dir = new File("D:/zhb_project/movision/zhb/code");
        int w = 200, h = 80;  
        /*for(int i = 0; i < 10; i++){  
