...
public class GetImgToWH {
    private int height;
    private int width;
    private String mimeType;

    public GetImgToWH(File file) throws IOException {
    ...
    public GetImgToWH(InputStream is) throws IOException {
        processStream(is);
    }

    public GetImgToWH(byte[] bytes) throws IOException {
