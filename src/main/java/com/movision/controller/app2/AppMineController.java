...
public class AppMineController {
    ...
    public Response getMineFollowCircle(@ApiParam(value = "用户id(必填，否则无法进入‘我的’页面或无法查看哪个用户的主页)") @RequestParam String userid,
    ...
    public Response getMineFollowAuthor(@ApiParam(value = "用户id(必填，否则无法进入‘我的’页面或无法查看哪个用户的主页)") @RequestParam String userid,
                                        @ApiParam(value = "第几页") @RequestParam(required = false, defaultValue = "1") String pageNo,
                                        @ApiParam(value = "每页多少条") @RequestParam(required = false, defaultValue = "10") String pageSize){
        Response response = new Response();
    ...
    public Response getMineFollowLabel(@ApiParam(value = "用户id(必填，否则无法进入‘我的’页面或无法查看哪个用户的主页)") @RequestParam String userid,
                                       @ApiParam(value = "第几页") @RequestParam(required = false, defaultValue = "1") String pageNo,
                                       @ApiParam(value = "每页多少条") @RequestParam(required = false, defaultValue = "10") String pageSize){
        Response response = new Response();
    ...
    public Response getMyfans(@ApiParam(value = "用户id(必填，否则无法进入‘我的’页面或无法查看哪个用户的主页)") @RequestParam String userid,
                              @ApiParam(value = "第几页") @RequestParam(required = false, defaultValue = "1") String pageNo,
                              @ApiParam(value = "每页多少条") @RequestParam(required = false, defaultValue = "10") String pageSize){
        Response response = new Response();
